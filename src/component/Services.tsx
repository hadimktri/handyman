...
export default function Services({
  ...
  return (
    <div
      className={`flex flex-col w-full border-t-[1px] border-slate-500 gap-8 py-6 mt-24`}
    >
      <Animate>
        <div className={`w-full flex items-center text-lg font-bold`}>
          ...
          <div className="hidden sm:block border-b-[1px] border-slate-500 w-32 m-3 mb-1" />
      ...
      <div className={`${S.flxBC} flex-col sm:flex-row w-full gap-4`}>
        ...
        >
          {images.map((item, idx) => (
            <div key={idx} className="py-2 rounded-2xl">
              <Image
                alt={item}
                src={`/${item}.jpg`}
                width={800}
